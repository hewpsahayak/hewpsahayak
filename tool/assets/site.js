...
function startDownload(button) {
    ...
    if (button.id === 'downloadBtnStandalone') {
        downloadURL = standaloneURL; secondURL = fallbackURL; installerName = 'HEWPSahayak_Installer.exe';
    } else {
        ...
        <div class="ticker-bar ticker-bar-global" style="flex-basis:100%; order:2; width:100%;">
            <div class="ticker-wrap">
                <div class="ticker-track">
                    <span class="ticker-item">🚀 HEWP Sahayak Tool • BOQ • Estimate • Variation • MB</span>
